	...
	\subsection{Spesifikasi Sistem}
		...
		\begin{itemize}
			...
			\item Estetika
				...
				\end{figure}
			\item Mekanik
				\subitem Mekanik yang dikembangkan akan didasari oleh \textit{puzzle game}. Hal ini juga tergambarkan pada kuesioner kode JG yang memiliki frekuensi paling banyak, yaitu \textit{puzzle game}. Pemain akan diminta menyelesaikan sebuah masalah yang terdapat pada setiap tahap untuk mencapai tahap selanjutnya.
